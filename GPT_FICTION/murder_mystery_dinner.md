...
Please note that the above prompts and the below output are the result of a couple iterations of refining and regenerating (after, for example, the murder was lame and unoriginal, or the murderer not identified or too obvious etc.) -- just tinkering until something cool or striking comes up. The real breakthrough came when I decided to give it a definition of camp with the plot prompt, as in "an aesthetic style and sensibility that regards something as appealing because of its bad taste and ironic value". Instructing GPT-4 to be campy is now my new favorite thing to do.
