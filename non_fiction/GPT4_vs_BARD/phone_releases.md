[_n.b. OpenAI is opening up their Web Browsing plugin to all ChatGPT Plus subscribers, but it seems that, although the Web Browsing model is listed under GPT-4, it is in fact a GPT-3 model_]
